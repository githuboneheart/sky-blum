...
while True:
    ...
    print(Fore.YELLOW + Style.BRIGHT + f"1. [ sKy ] Lounge")
...
sKy.me
    ...
    print(Fore.YELLOW + Style.BRIGHT + "Free Konsultasi Join Telegram Channel: https://t.me/iniskyreal")
    print(Fore.BLUE + Style.BRIGHT + "Buy me a coffee :) 089529918969 GOPAY / DANA")
    print(Fore.RED + Style.BRIGHT + "iniskyreal :)\n\n")
